...
if __name__ == '__main__':
    ...
    with gr.Blocks(title='Hex-RVC') as app:
        ...
        gr.Label('Hex RVC WebUI', show_label=False)
        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                with gr.Row():
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['rmvpe', 'rmvpe+', 'fcpe', 'mangio-crepe', 'hybrid[fcpe+rmvpe]'], value='rmvpe', label='Pitch detection algorithm', info='Best option is rmvpe (clarity in vocals), then mangio-crepe (smoother vocals)')
